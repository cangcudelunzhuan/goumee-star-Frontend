<template>
  <section class="page-section">
    <el-row class="search-star" v-if="!$props.starName">
      <div>
        <input type="text" v-model="searchStarName" @keyup.enter="searchStarFans" @focus="isOnfoucs = true"
          @blur="isOnfoucs = false" :class="isOnfoucs ? 'foucs-bg':'blur-bg'" placeholder="请输入主播昵称">
      ...
      <el-row>
        <el-col :span="12">
          <div class="sex-account">
            ...
            <genderChart v-loading="genderChartLoading" :genderChartData="genderChartData"></genderChart>
          </div>
        </el-col>
        <el-col :span="12">
    ...
    <el-row class="city-distri">
      ...
      <el-row>
        <el-col :span="12">
          <div class="chart-par">
            <mapChart v-loading="genderChartLoading" :barNameData="barNameData" :areaChartData="areaChartData"></mapChart>
          </div>
        </el-col>
        <el-col :span="12">
          <div class="chart-par">
            <areaBarChart :barNameData="barNameData" v-loading="genderChartLoading" :areaChartData="areaChartData"></areaBarChart>
          </div>
        </el-col>
      </el-row>
    </el-row>
      ...
      <el-row type="flex" justify="space-between">
        <el-col :span="12">
          <div class="pay-like-part">
            ...
            <cateChart :cateChartData="cateChartData" v-loading="genderChartLoading"
              :cateNameChartData="cateNameChartData"></cateChart>
          </div>
        </el-col>
        <el-col :span="12">
          <div class="pay-like-part">
            <span class="chart-tit">风格定位</span>
            <styleChart v-loading="genderChartLoading" :styleChartData="styleChartData"
              :styleNameChartData="styleNameChartData"></styleChart>
          </div>
        </el-col>
      </el-row>
    </el-row>
    <el-row class="life-like">
      ...
      <div>
        <radarChart v-loading="genderChartLoading" :radarChartData="radarChartData"
          :radarChartNameData="radarChartNameData"></radarChart>
      </div>
    </el-row>
  </section>
</template>
