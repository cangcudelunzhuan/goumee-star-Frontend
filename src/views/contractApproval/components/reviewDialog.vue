<!--
 * @Description: 合同附件审批弹窗
 * @Author: 白青
 * @Date: 2019-09-09 16:49:18
 * @LastEditTime: 2019-09-09 17:13:24
 * @LastEditors: 白青
 -->
...
<template>
  <div id="review-dialog">
    <el-dialog
      ...
      @close="handleCancel"
    >
      <div class="title" slot="title">合同附件审核</div>
      <div class="review-main">
        <div v-if="attachmentInfo" class="contract-info">
          <p>合同编号：<span class="contract-number">{{attachmentInfo.contract_info.contract_uid}}</span></p>
          <p>合同状态：<span :class="`status-dot ${'status-dot-' + attachmentInfo.contract_annex_info.contract_annex_status}`"><em></em>{{attachmentInfo.contract_annex_info.contract_annex_status_str}}</span></p>
        </div>
